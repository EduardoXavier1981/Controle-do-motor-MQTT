...
#define WIFI_SSID "GBMX EDUARDO"
#define WIFI_PASSWORD "gbmx445095"
...
int main(){
  ...
  while(true){
    ...
    if (board_button_read()){
      mqtt_publish(cliente_mqtt, "controle/motor", "Envie um Plaintext como motor/control", 37, 0, false, &mqtt_request_cb, NULL);
      sleep_ms(100);
      mqtt_publish(cliente_mqtt, "controle/motor", "H para horário, A para anti-horário + porcentagem desejada", 58, 0, false, &mqtt_request_cb, NULL);
      sleep_ms(100);
      mqtt_publish(cliente_mqtt, "controle/motor", "Ex: H 50, A 100, H 75...", 24, 0, false, &mqtt_request_cb, NULL);
      sleep_ms(100);
    }
